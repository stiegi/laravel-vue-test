                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-blue-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laravel has wonderfull documentation covering every aspect of the framework. Whether you
